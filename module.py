...
class Seminar(Module):
    ...
    def __str__(self):
        return "Seminar in " + self.get_title() + " under the topic: " + self.get_topic()
...
class Thesis(Module):
    ...
    def __str__(self):
        return "Bachelor Thesis on the topic: " + self.get_topic() + " in the Reseach Group " + self.get_research_group()
